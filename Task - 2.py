# Task - 2 Преведущий проект (Меню Ресторана) дополнить итерационным протоколом и протоколом последовательности.
...
class RestaurantMenu:
    ...
    def __next__(self):
        if self.index < len(self.menu_categories):
            current_menu_category = self.menu_categories[self.index]
            self.index += 1
